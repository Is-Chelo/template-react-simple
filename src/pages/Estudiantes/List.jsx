...
const List = () => {
  ...
  const handleDelete = (id) => {
    new Peticion(`/estudiantes`).deleteItem(id)
    setData(!data)
  };

  let datos = new Peticion("/estudiantes").getData(data);
  ...
  const columns = [
    ...
    { field: "direccion", headerName: "direccion", width: 200 },
    {
      ...
      renderCell: (params) => {
        return (
          <>
            <Link to={`/estudiantes/` + params.row.id}>
      ...
      <div className="my-card">
        ...
        <div className="row mb-3">
          <div className="productTitleContainer">
            <h2 className="productTitle">Lista de Estudiantes</h2>
            <Link to="/estudiantes/add">
